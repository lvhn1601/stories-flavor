...
const OrderModal = ({ showDetails, showEdit, toggleModal, order, role }: any) => {
  ...
  return (
    <>
      <div className={`backdrop-filter-sm visible fixed left-0 top-0 z-[99999] flex min-h-screen w-full justify-center items-center bg-[#000]/40 px-4 py-8 sm:px-8`}>
        <div className="shadow-7 relative w-full max-w-[80vw] max-h-[90vh] lg:max-w-[60vw] h-auto scale-100 transform rounded-[15px] bg-white transition-all flex flex-col justify-center items-center">
          <button
