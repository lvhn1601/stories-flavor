...
const Cart = () => {
  ...
  return cartItems.length > 0 ? (
    <section className="overflow-hidden py-20">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
          ...
          <button className="text-primary">Xoá hết</button>
        </div>
    ...
    <div className="text-center py-20">
      ...
      <p className="pb-6">Giỏ hàng trống!</p>

      <Link
        href="/"
        className="w-96 mx-auto flex justify-center font-medium text-white bg-primary py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-opacity-95"
      >
        Tiếp tục mua sắm
      </Link>
    </div>
